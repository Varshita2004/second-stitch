...
urlpatterns = [
    ...
    path('logout', LogoutView.as_view(template_name='ecom/login.html'),name='logout'),
    ...
    path('ngos/', views.list_ngos, name='list_ngos'),
    path('donate/<int:ngo_id>/', views.donate_clothes, name='donate_clothes'),
